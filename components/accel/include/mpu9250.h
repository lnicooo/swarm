...
extern bool mpu9250_read_all(imu_sensor_data_t* data);
extern bool mpu9250_read_mag(imu_sensor_data_t* imu);
extern bool mpu9250_read_gyro_accel(imu_sensor_data_t* imu);
extern float mpu9250_collision();
